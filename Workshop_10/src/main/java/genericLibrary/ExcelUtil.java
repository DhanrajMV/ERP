...
public class ExcelUtil implements IAutoConstants{
	 ...
	 */
	public double readNumberDataFromExcel(String sheetName,int rowNum,int cellNum) throws InvalidFormatException {
		try {
	 ...
	 * @throws InvalidFormatException 
	 */
	public boolean readBooleanDataFromExcel(String sheetName,int rowNum,int cellNum) throws InvalidFormatException {
		try {
			FileInputStream fis=new FileInputStream(abspath);
			workbook = WorkbookFactory.create(fis);
		} catch (EncryptedDocumentException e) {
	 ...
	 * @throws InvalidFormatException 
	 */
	public String readStringDataFromExcel(String sheetName,int rowNum,int cellNum) throws InvalidFormatException {
		try {
			FileInputStream fis=new FileInputStream(abspath);
			workbook = WorkbookFactory.create(fis);
		} catch (EncryptedDocumentException e) {
	 ...
	 * @throws InvalidFormatException 
	 */
	public Date readDateValueFromExcel(String sheetName,int rowNum,int cellNum) throws InvalidFormatException {
		try {
			FileInputStream fis=new FileInputStream(abspath);
			workbook = WorkbookFactory.create(fis);
		} catch (EncryptedDocumentException e) {
	 ...
	 * @throws InvalidFormatException 
	 */
	public String readAnyDataFromExcelInString(String sheetName,int rowNum,int cellNum) throws InvalidFormatException {
	 ...
	 * @throws InvalidFormatException 
	 */
	public String[][] getMultipleData(String sheetName) throws InvalidFormatException {
		try {
			FileInputStream fis=new FileInputStream(abspath);
			workbook = WorkbookFactory.create(fis);
		} catch (EncryptedDocumentException e) {
